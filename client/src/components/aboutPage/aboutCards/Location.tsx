  ...
  return (
    <div className=' dark:text-gray-200 dark:bg-slate-800 border-slate-700 border rounded-2xl p-8 shadow-sm'>
      <header className='flex items-center gap-3 mb-4!'>
        <div className=' dark:bg-blue-900/30 bg-blue-100 rounded-lg flex items-center justify-center w-12 h-12'>
          <img
            width={30}
      ...
      <div className='bg-linear-to-br from-blue-100 to-indigo-100 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl p-6 mb-4 overflow-hidden flex items-center justify-center'>
        <div className='p-5 w-40 h-40 bg-radial dark:from-blue-900/20 from-40% dark:to-blue-900/50 rounded-full flex justify-center flex-col items-center'>
